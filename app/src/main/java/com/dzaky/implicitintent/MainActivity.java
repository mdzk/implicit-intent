...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_move_activity) {
            ...
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_KULIAH, "PEMROGRAMMAN BERBASIS MOBILE");
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_KELAS,0);
